 ...
 */
export class DeleteFilterListModalUi extends Component {
  constructor(props) {
    super(props);
...
DeleteFilterListModalUi.propTypes = {
  selectedFilterLists: PropTypes.array,
};

export const DeleteFilterListModal = injectI18n(DeleteFilterListModalUi);
